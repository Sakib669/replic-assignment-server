...
async function run() {
  try {
    ...
    const usersCollection = client.db('replicTaskDB').collection('users');
    const classesCollection = client.db('replicTaskDB').collection('classes');
    const paymentsCollection = client.db('replicTaskDB').collection('payments');
    const classesCartCollection = client.db('replicTaskDB').collection('classesCart');

    const popularTeachersCartCollection = client.db('replicTaskDB').collection('popularTeachers');
